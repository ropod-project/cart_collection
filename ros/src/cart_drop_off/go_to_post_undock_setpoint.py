...
class GoToPostUndockSetpoint(smach.State):
    ...
    def execute(self, userdata):
        ...
        if self.robot_pose is None:
            rospy.logerr("[cart_collector] Precondition for GoToPostUndockSetpoint not met: Robot pose not available. Aborting.")
            return 'timeout'
        ...
        nav_goal.goal = userdata.post_undock_setpoint
